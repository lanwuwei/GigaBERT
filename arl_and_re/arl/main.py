...
if __name__ == '__main__':
    ...
    training_data_path = '../'+source_language + '_arl/train.json'
    dev_data_path = '../'+source_language + '_arl/dev.json'
    test_data_path = '../'+target_language + '_arl/test.json'
    ...
    print('Loading testing data...\n')
    test_dataloader, test_size = create_dataloader('../en_arl/test.json', set_type='test',
                                                   batchsize=args.batchsize,
                                                   max_seq_length=args.max_seq_length, tokenizer=tokenizer,
                                                   num_duplicate=args.num_duplicate, proc=processor)
    ...
    print('Loading testing data...\n')
    test_dataloader, test_size = create_dataloader('../ar_arl/test.json', set_type='test',
                                                   batchsize=8,
